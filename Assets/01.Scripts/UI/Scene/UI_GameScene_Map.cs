    ...
    public void FirstSetting()
    {
        ...
        GetButton(Buttons.CoinBtn).AddButtonEvent(() =>
       {
        ...
        this.SetListener(GameObserverType.Game.OnCheatModeOn, () =>
        {
            ...
            GetImage(Images.Tutorial).GetComponent<RectTransform>().anchoredPosition = Managers.LocalData.CheatMode == 0 ? new Vector2(475, -540) : new Vector2(475, -690); // 초기 위치를 화면 밖으로 설정
        });
