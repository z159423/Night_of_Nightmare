...
NS_ASSUME_NONNULL_BEGIN
    ...
    #define LongriverKeyChain_SYNCHRONIZATION_AVAILABLE 1
#endif

#if __IPHONE_3_0 || __MAC_10_9
    // Keychain access group available at compile time
    #define LongriverKeyChain_ACCESS_GROUP_AVAILABLE 1
#endif

#ifdef LongriverKeyChain_SYNCHRONIZATION_AVAILABLE
typedef NS_ENUM(NSUInteger, LongriverKeyChainQuerySynchronizationMode) {
    LongriverKeyChainQuerySynchronizationModeAny,
    LongriverKeyChainQuerySynchronizationModeNo,
    LongriverKeyChainQuerySynchronizationModeYes
};
#endif
 ...
 */
@interface LongriverKeyChainQuery : NSObject
...
#ifdef LongriverKeyChain_ACCESS_GROUP_AVAILABLE
...
@property (nonatomic) LongriverKeyChainQuerySynchronizationMode synchronizationMode;
#endif
...
/**
 ...
 LongriverKeyChain_SYNCHRONIZATION_AVAILABLE is only for compile time. If you are checking for the presence of synchronization,
